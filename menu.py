...
class Menu:
    ...
    def draw_start_menu(self):
        """
        Отрисовка элементов стартового меню.

        Метод отвечает за отрисовку заголовка и инструкций для начала игры и выхода.
        """
        ...
        end_text = 'Чтобы выйти из игры нажмите esc'
